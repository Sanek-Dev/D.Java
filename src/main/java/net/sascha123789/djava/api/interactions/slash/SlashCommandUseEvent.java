...
public class SlashCommandUseEvent extends BaseInteraction {
    ...
    public SlashCommandUseEvent(DiscordClient client, String id, String token, String appId, DiscordLanguage locale, String channelId, String guildId, DiscordLanguage guildLocale, BaseChannel channel) {
