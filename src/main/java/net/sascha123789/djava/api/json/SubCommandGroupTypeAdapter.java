...
public class SubCommandGroupTypeAdapter extends TypeAdapter<SubCommandGroup> {
    @Override
    public void write(JsonWriter out, SubCommandGroup src) throws IOException {
        out.beginObject();
    ...
    @Override
    public SubCommandGroup read(JsonReader in) throws IOException {
        return null;
    }
}
